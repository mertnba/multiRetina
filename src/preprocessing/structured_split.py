...
if __name__ == "__main__":
    ...
    df = resolve_multi_class_patients(df)
    df = stratified_split(df)

    print("[INFO] Copying images into train/val/test folders...")
    copy_images(df, source_paths=source_paths, output_dir=args.output)

    print("[INFO] Verifying image counts...")
    verify_counts(args.output, args.classes)

    print("[DONE] Dataset successfully split and organized.")
